...
function DayCell({
  ...
  return (
    <div
      ...
      className={`group relative min-h-[204px] border-r border-b border-edge last:border-r-0 px-2.5 pt-2.5 pb-0.5 cursor-pointer transition flex flex-col overflow-hidden
      ...
      <div className={`mt-2 space-y-1 pr-1 ${items.length > 3 ? 'max-h-[140px] overflow-y-auto' : ''}`}>
        {items.map(p => (
