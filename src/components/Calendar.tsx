...
function DayCell({
  ...
  return (
    <div
      ...
      className={`group relative min-h-[204px] border-r border-b border-edge last:border-r-0 px-2.5 pt-2.5 pb-0 cursor-pointer transition flex flex-col overflow-hidden
